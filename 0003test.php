...
class CryptographyTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_encypt_set1() {
        $actual = 12;

        $testArray = array('1', '2', '3');
        $expected = $this->targetClass->encypt($testArray);

        $this->assertEquals($expected, $actual);
    }

    public function test_encypt_set2() {
        $actual = 36;
    ...
    public function test_encypt_set3() {
    ...
    public function test_encypt_set4() {
        $actual = 2;
